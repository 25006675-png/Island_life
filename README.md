...
| **Crypto-Reward / Tokenomics Concept** | **Dropped** | Mentor Zach advised us to drop it. Crypto rewards are common in hackathon pitches, add friction, and pull attention away from the wellness idea. |
