...
The version scripts, v1–v7 blends and leaf studies are in `archive/trees/Purple tree versions/`.

```
"C:\Program Files\Blender Foundation\Blender 5.2\blender.exe" --background --python "archive/trees/Purple tree versions/create_ghibli_tree_v6.py"
```
